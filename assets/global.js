...
class VariantSelects extends HTMLElement {
  ...
  updateMedia() {
    ...
    if (this.dataset.layout == 'card') { 
      ...
      $('.product-main-slider').slick('slickGoTo', index-1);
      $('.product-thumb-slider').slick('slickGoTo', index-1);
  ...
  updateURL() {
   ...
   update_notify(){
    ...
    $('#notify-me-wrapper').find('.variant-title').text(this.currentVariant.title); 
  ...
  updateVariantInputss() {
        if (this.dataset.layout == 'pro-main-section') {
      const product = this.closest('.pro-main-section');
